...
# WITHsasdOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.
...
PROJECT_ID = 'terraform-andrii-besaha'

# CloudSQL & SQLAlchemy configuration
# Replace the following values the respective values of your Cloud SQL
# instance.
CLOUDSQL_USER = 'root'
CLOUDSQL_PASSWORD = 'qwerty123'
CLOUDSQL_DATABASE = 'bookshelf'
# Set this value to the Cloud SQL connection name, e.g.
#   "project:region:cloudsql-instance".
# You must also update the value in app.yaml.
CLOUDSQL_CONNECTION_NAME = 'terraform-andrii-besaha:us-central1:bookshelf-db3'
...
CLOUD_STORAGE_BUCKET = 'bookshelf-bucketv6'
